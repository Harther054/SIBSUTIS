...
InputDialog_Ivanov::InputDialog_Ivanov(QWidget *pwgt) : QDialog(pwgt)
{
    m_ptxtFirstName = new QLineEdit;
    m_ptxtLastName = new QLineEdit;

    QLabel* plblFirsName = new QLabel("&Имя");
    QLabel* plblLastName = new QLabel("&Фамилия");

    plblFirsName->setBuddy(m_ptxtFirstName);
    ...
    ptopLayout->addWidget(plblFirsName, 0, 0);
...
QString InputDialog_Ivanov::firstName() const
{
    return m_ptxtFirstName->text();
}

QString InputDialog_Ivanov::lastName() const
{
